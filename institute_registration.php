...
<body>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container">
      <div class="row">
        <i class="fa fa-university text-white test-series-front mb-4" style="font-size:150px;"></i>
        <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center" style="color:white;">
          <h1 data-aos="fade-up" class="text-white">Institute Registration</h1>
          <p data-aos="fade-up" data-aos-delay="400" style="font-size:15px;">Join CareerTrackon and spreed the knowledge everywhere.</p>
        </div>
      </div>
    </div>
  </section><!-- End Hero -->
  <div class="join container" style="background:#1b2162;">
    <div class="container row" style="padding-top:3%">
      <div class="col-md-2 col-sm-6 col-6 d-flex"><a href="#services" class="text-white"><i class='fa fa-th-large'></i> What We Have</a></div>
      <div class="col-md-2 col-sm-6 col-6 d-flex"><a href="" class="text-white"><i class='fa fa-info-circle'></i> Instructions</a></div>
      <div class="col-md-2 col-sm-6 col-6 d-flex dropdown" ><a href="" class="text-white"><i class='fa fa-file-text-o'></i> Privacy & Policy</a>
      </div>
              ...
              <form  method="POST" class=" needs-validation" novalidate id="reg-form">
                ...
                <input type="hidden" name="token" value="<?= csrf_token(); ?>">
                    <div class="form-group">
                      <input type="text" name="institute"  class="form-control my-input" id="firstname" placeholder="Institute Name" autocomplete="off" required>
                    </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <input type="text" name="ownerfirstname"  class="form-control my-input" id="ownerfirstname" placeholder="Owner First Name" autocomplete="off" required>
                    </div>
                    <div class="invalid-feedback">
                      Please enter valid Owner First Name
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <input type="text" name="ownerlastname"  class="form-control my-input" id="ownerlastname" placeholder="Owner Last Name" autocomplete="off" required>
                    </div>
                    <div class="invalid-feedback">
                      Please enter valid Owner Last Name
                    </div>
                  </div>
                </div>
                <!-- email input -->
                ...
                <!-- address input -->
                <div class="form-group">
                  <textarea type="text" name="institute_address"  class="form-control my-input" id="institute_address" placeholder="Address" autocomplete="off" required></textarea>
                </div>
                <div class="invalid-feedback">
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      <input type="text" name="city"  class="form-control my-input" id="city" placeholder="City" autocomplete="off" required>
                    </div>
                    <div class="invalid-feedback">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <input type="text" name="state"  class="form-control my-input" id="state" placeholder="State" autocomplete="off" required>
                    </div>
                    <div class="invalid-feedback">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <input type="number" name="pincode"  class="form-control my-input" id="pincode" placeholder="Pin Code" autocomplete="off" required>
                    </div>
                    <div class="invalid-feedback">

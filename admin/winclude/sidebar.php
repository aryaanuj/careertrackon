 <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="side_menu" id="question_catA">
                            <a href="question_cat.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-tags"></span><p>Questions Category</p></a>
                        </li>
